export const courses = [
  {
    ...
    image:
      "https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/19/desktop-computer.png",
    image2:
...

  {
    ...
    image2:
      "https://iqtidor.uicgroup.tech/media/course/images/2024/04/19/7_meeting_with_client.webp",
    description:
      "3D modeling is considered one of the most profitable areas, the average salary starts from $500. This area is now a modern profession!!!",
    whatYouWillLearn: [
      {
        title: "Modeling",
        icon: "https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/17/3d.png",
      },
      {
        title: "Kengaytirilgan modellashtirish",
        icon: "https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/17/3d.png",
      },
      {
        title: "Atrof-muhit va kuzatish",
        icon: "	https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/17/3d.png",
      },
      {
        title: "Raqamli haykaltaroshlik",
        icon: "	https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/17/3d.png",
      },
    ],
    program: [
      {
        ...
        details: [
          ...
          "Render 1-daraja",
          "Compositinga kirish",
          "Autodesk 3DsMax dasturi bilan tanishuv",
          "1-Modelni tayyorlash",
          "3D modeling va CG asoslari",
          "Referencelar bilan ishlash",
          "Shaderlar",
          "Materiallar",
          "Lifhting",
          "Uv o'ramini ochish",
      ...
      },
      {
        title: "Kengaytirilgan modellashtirish",
        details: [
          "Substance Painter dasturi bilan tanishuv",
          "Substance Painter dasturi bilan tanishuv",
          "RizomUV dasturi bilan tanishuv",
          "Murakkab, ko‘p sloydan iborat Texturalash",
          "Marmoset asboblar sumkasi va aylanuvchi stol Render",
          "Murakkab texturali Pro model tayyorlash",
        ],
      },
      {
        title: "Atrof-muhit va kuzatishi",
        details: [
          "Sodda Environment tayyorlash",
          "Quixel Bridge dasturi bilan ishlash",
          "Scatterlar",
          "Ma’lum lokatsiyani sahnalashtirish",
          "Shotlar bilan ishlash",
          "Tracking",
          "Murakkab Rendering",
          "VFX",
          "Compositing Pro",
          "O‘zimiz olgan shot uchun VFX",
        ],
      },
  ...
  },
  {
    ...
    image:
      "https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/17/IT_ingliz.svg",
    image2:
      "https://iqtidor.uicgroup.tech/media/course/images/2024/04/19/7_meeting_with_client.webp",
    description:
    ...
    whatYouWillLearn: [
      {
        ...
        icon: "https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/17/IT_ingliz.svg",
      },
      {
        title: "Grafik foydalanuvchi interfeyslari",
        icon: "https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/17/IT_ingliz.svg",
      },
    ],
    program: [
  ...
  },
  {
    ...
    image:
      "https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/17/SMM_kurs.svg",
    image2:
      "https://iqtidor.uicgroup.tech/media/course/images/2024/04/19/7_meeting_with_client.webp",
    description:
      "Social Media Marketing (SMM) - kompaniyaning mahsulot va xizmatlarini sotish uchun ijtimoiy media saytlari va ijtimoiy tarmoqlardan foydalanishning strategik yo‘li hisoblanadi. Ijtimoiy media marketing tarmoqlari orqali yangi mijozlarga erishish, kompaniyaning obro‘sini oshirish hamda  mavjud mijozlar bilan ishlash, va ular istagan madaniyat, maqsad yoki yo‘nalishni targ‘ib qilish bilan shug‘ullanadi.",
    whatYouWillLearn: [
      {
        title: "SMM va Marketing tushunchalari",
        icon: "https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/17/SMM_kurs.svg",
      },
      {
      ...
      {
        title: "Ish topish va mijozlar bilan ishlah",
        icon: "https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/17/SMM_kurs.svg",
      },
      {
        title: "Mobilografiya",
  ...
  {
    id: 9,
    title: "Foundation (Pyton)",
    image:
      "https://iqtidor.uicgroup.tech/media/courses/icons/2024/10/24/foundation.png",
    image2:
      "https://iqtidor.uicgroup.tech/media/course/images/2024/04/19/7_meeting_with_client.webp",
    description:
      "Python tili mavjud bo'lgan dasturlash tillari ichida eng ko'p ishlatiladigan tillardan biri hisoblanib, u sintaksisini soddaligi va murakkab emasligi bilan ajralib turadi. Bu esa tilni o'rganishni osonlashtiradi va foydalanuvchilar soni ham ko'pligini taminlaydi.",
    whatYouWillLearn: [
      {
        title: "Windows ish muhiti",
        icon: "https://iqtidor.uicgroup.tech/media/courses/icons/2024/04/19/desktop-computer.png",
...

  {
    ...
    title: "Mobile Developer",
    image:
      "https://iqtidor.uicgroup.tech/media/courses/icons/2024/10/24/backend.png",
    image2:
      "https://iqtidor.uicgroup.tech/media/course/images/2024/04/19/7_meeting_with_client.webp",
    description:
      "Kursda siz kompyuter bilan to‘liq ishlashni o‘rganasiz va undan tashqari ZOOM, Word, Excel, Point va Access dasturlarida ishlashni o‘rganasiz.",
